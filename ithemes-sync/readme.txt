...
* Bug Fix: Prevent PHP warnings from being displayed during WP REST API requests.
* Tweak: Remove logic that sets WP_ADMIN to true during verb request handling to avoid plugin conflicts.
